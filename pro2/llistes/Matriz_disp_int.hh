...
// Descripción del tipo: representa matrices con implementacion dispersa
...
// contiene el par (j,x).
// Los pares de una lista están ordenados crecientemente por su primer elemento
...
public:
  ...
  /* Pre: 0<=i< num filas del parametro implicito;  0<=j< num columnas del 
     parametro implicito */
  /* Post: el parametro implícito queda como el original pero con x en la
     la posición [i][j] */
  ...
  /* Pre: el canal standard de entrada contiene pares de enteros que
     ...
     de cada fila aparece su número de valores distintos de 0 */
  /* Post: El parámetro implícito contiene la matriz formada por los pares
  ...
  /* Pre: cierto */
  /* Post: Se han escrito los valores del parámetro implícito en el canal
